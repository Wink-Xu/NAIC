...
class MSMT17(object):
    ...
    def __init__(self, root='data', verbose=True, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'MSMT17_V1/test_AL/_align')
        self.test_dir = osp.join(self.dataset_dir, 'MSMT17_V1/train_AL/_align')
        self.list_train_path = osp.join(self.dataset_dir, 'MSMT17_V1/list/list_train_20_110.txt')
        self.list_val_path = osp.join(self.dataset_dir, 'MSMT17_V1/list/list_val.txt')
        self.list_query_path = osp.join(self.dataset_dir, 'MSMT17_V1/list/list_val.txt')
        self.list_gallery_path = osp.join(self.dataset_dir, 'MSMT17_V1/list/list_train.txt')
